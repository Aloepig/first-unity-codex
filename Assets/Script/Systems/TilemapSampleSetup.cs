...
public class TilemapSampleSetup : MonoBehaviour
{
    ...
    public void BuildSampleGround()
    {
        ...
        if (groundTransform == null)
        {
            ...
            compositeCollider = groundObject.AddComponent<CompositeCollider2D>();
        }
        else
        {
            ...
            compositeCollider = groundTransform.GetComponent<CompositeCollider2D>() ?? groundTransform.gameObject.AddComponent<CompositeCollider2D>();
        }
